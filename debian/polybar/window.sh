...
# directly plagarized from my kali config which was plagarized from https://github.com/aroma1994/polybar-windows/blob/master/polybar-windows.sh 
# i'm still too lazy to fork so
